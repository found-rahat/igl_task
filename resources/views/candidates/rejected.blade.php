...
<div class="max-w-7xl mx-auto">
    <h2 class="text-2xl font-bold mb-6">Rejected Candidates</h2>
        ...
        <table class="min-w-full divide-y divide-gray-200">
            <thead class="bg-gray-50">
                <tr>
                    ...
                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Rejection Date</th>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                @empty
                <tr>
                    <td colspan="6" class="px-6 py-4 text-center text-gray-500">No rejected candidates found.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
