        ...
        <div id="sidebar"
            ...
            <nav class="mt-6">
                    ...
                    <ul class="mt-2">
                        <li class="mb-1">
                            <a href="{{ route('dashboard') }}"
                                class="flex items-center px-4 py-2 text-sm font-medium rounded-lg hover:bg-blue-700 transition-colors {{ request()->routeIs('admin.dashboard', 'staff.dashboard') ? 'bg-blue-700' : '' }}">
                ...
                @if (auth()->user()->role === 'admin')
                    ...
                    <!-- Public Candidate Search Link -->
                    <div class="px-4 mt-6">
                        <h2 class="text-sm font-semibold text-blue-300 uppercase tracking-wider">Public Access</h2>
                        <ul class="mt-2">
                            <li class="mb-1">
                                <a href="{{ route('candidate.search.form') }}" class="flex items-center px-4 py-2 text-sm font-medium rounded-lg hover:bg-blue-700 transition-colors">
